...
test_submit <- read.csv(here('data','NIJ_s_Recidivism_Challenge_Test_Dataset2.csv'))
...
table(full_data$Recidivism_Arrest_Year1,
      full_data$Recidivism_Arrest_Year2)
...
save.image("B:/Ongoing_Research/nij/nij/data/final_dataY2.RData")
